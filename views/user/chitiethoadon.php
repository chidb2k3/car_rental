    ...
    <div class="site-wrap" id="home-section">
            ...
            <div class="container">
                <div class="row align-items-end ">
                    <div class="col-lg-5">
                        ...
                        <div class="intro">
                            <h4><strong>Chi tiết hóa đơn</strong></h4>
        ...
        <div class="site-section bg-light">
            <div class="container">
                <div class="row">
                    <!-- //start xe -->
                    <h4 style="color: red; font-size: 1.5em; font-weight: bold; text-transform: uppercase;">Hóa đơn HD-
                        <?php if (isset ($_GET['idhoadon'])) {
                            echo $_GET['idhoadon'];
                        } ?>
                    </h4>
                ...
                <div class="row">
                    <!-- //start xe -->
                    <h4 style="color: red; font-size: 1.5em; font-weight: bold; text-transform: uppercase;">Bao gồm:
                    </h4>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <tr>
                                <?php
                                $stt = 0;
                                foreach ($this->dschitiethoadon as $chitiet) {
                                    if ($chitiet->getIdhoadon() == $idhoadon) {
                                        echo '<tr>';
                                        echo '<td>' . ++$stt . '</td>';
