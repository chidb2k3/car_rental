...
<body>
    ...
    include ('menu.php');
    ?>
    <!-- <button id="btn-them">Thêm Khách Hàng</button> -->
    ...
    <div class="container-fluid pt-4 px-4" id="danhsach">
        <div class="bg-light text-center rounded p-4">
            <div class="d-flex align-items-center justify-content-between mb-4">
                <h6 class="mb-0">Danh Sách Khách Hàng (Số lượng:
                    <?php echo $this->soLuongKhachHang(); ?>)<span style="color :red;">
                        <?php if (isset ($_SESSION['thongbao'])) {
                            echo $_SESSION['thongbao'];
                        }
                        unset($_SESSION['thongbao']); ?>
                ...
                <form action="" method="POST">
                    <input name="timkiem" class=" mr-sm-2" type="search" placeholder="Nhập tên khách hàng!" required
                ...
                <form method="GET">
                    <select name="sl" class="">
                        <option value="<?php echo $this->soLuongKhachHang(); ?>">All</option>
                    ...
                    <button class="btn btn-outline-success " name="cv" value="khachhang" type="submit">ok</button>
                </form>


                <a href="?cv=khachhang">Show All</a>
            </div>
                ...
                <table class="table text-start align-middle table-bordered table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        if (isset ($_GET['sl'])) {
                            ...
                            $sotrang = ceil(count($this->dsuser) / $sl);
                            $tranghientai = isset ($_GET['page']) ? $_GET['page'] : 1;
                            $batdau = ($tranghientai - 1) * $sl;
                            $arr = array_slice($this->dsuser, $batdau, $sl);
                            if (isset ($_POST['timkiem'])) {
                                foreach ($this->dsuser as $user) {
                                    if ($user->getFullname() == $_POST['timkiem']) {
                                        $count++;
                                        echo '<tr>';
                                        echo '<td>' . ++$stt . '</td>';
                                        ...
                                        echo '<td><a class="btn btn-sm btn-danger" href="?cv=xoakhachhang&id=' . $user->getIduser() . '">Xóa</a></td>';
                                        echo '<td><a class="btn btn-sm btn-primary" id="btn-suadanhmuc" href="#">Update</a></td>';
                                        echo '</tr>';
                ...
                <div style="display: flex; justify-content: center; margin-top: 30px;">
                    ...
                    <ul class="pagination ">'; ?>
                        ...
                        <li class="page-item <?php if ($p == 1) {
                            ...
                            <a class="page-link" href="?cv=khachhang&sl=<?php echo $sl ?>&page=<?php $p--;
                               echo $p;
                               $p++;
                            ...
                            for ($i = 1; $i <= $sotrang; $i++) {
                                ...
                                href='?cv=khachhang&sl=$sl&page=$i'>$i</a></li>";
                                } else {
                        ...
                        <li class='page-item disabled'  >
                            <a class='page-link' href='?cv=khachhang&sl=$sl&page=$p'>Next</a>
                        </li>
                    </ul>
                </nav>";
                            } else {
    ...
    <div class="container-fluid pt-4 px-4" id="themdanhmuc">
        <div class="bg-light text-center rounded p-4">
            <div class="d-flex align-items-center justify-content-between mb-4">
                <h6 class="mb-0">Thêm khách hàng</h6>
            </div>
            <div class="table-responsive">
    ...
    <div class="container-fluid pt-4 px-4" id="suadanhmuc">
        <div class="bg-light text-center rounded p-4">
            <div class="d-flex align-items-center justify-content-between mb-4">
                <h6 class="mb-0">Cập nhật khách hàng</h6>
            </div>
            <div class="table-responsive">
